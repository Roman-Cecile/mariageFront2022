		...
		<>
								...
								<div className={classes.navbar}>
									{navbarActions.map(({ text, link, icon }) => (
										<NavLink className={classes.hoverLink} to={link}>
											<Typography className={classes.fontFamilyLink} align="center">
												{text}
											</Typography>
											{icon}
										</NavLink>
			...
			<Switch>
				{isLogged ? (
					...
					<>
						<Route>
							<Login axiosLogin={axiosLogin} isLogged={isLogged} message={message} />
						</Route>
					</>
				)}
			</Switch>
			<Drawer open={open} setOpen={setOpen} isLogged={isLogged} axiosLogout={axiosLogout} />
		</>
	);
};
